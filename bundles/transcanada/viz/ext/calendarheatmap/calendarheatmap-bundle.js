define("calendarheatmap-bundle", ["transcanada_viz_ext_calendarheatmap-src/js/flow",
	"css!transcanada_viz_ext_calendarheatmap-src/style/default.css"
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./transcanada_viz_ext_calendarheatmap-src/resources/templates"
				}]
			}
		}]
	});
